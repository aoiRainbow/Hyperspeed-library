...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Oa(e,t,n){let r=new Float32Array(ma),i=new q(0,1,0);return new $r({name:`SphericalGaussianBlur`,defines:{n:ma,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:ja(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ka(){return new $r({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:ja(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Aa(){return new $r({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ja(),fragmentShader:`
	...
	`}var Ma=class extends Tt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new Br([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
    ...
    `,document.body.appendChild(i);let a=new Ci,o=new nn,s=[];e.forEach((e,t)=>{let n=new $r({uniforms:{uTexture:{value:a.load(e.image)},uTime:{value:0},uDistort:{value:e.distort||!1}},vertexShader:`
        varying vec2 vUv;
        uniform float uTime;
    ...
    `,side:2,transparent:!0}),r=new Or(new Gr(1,1,16,16),n);r.position.set((Math.random()-.5)*12,(Math.random()-.5)*12,(Math.random()-.5)*10),r.rotation.set(Math.random()*Math.PI,Math.random()*Math.PI,0);let i=e.scale||1;r.scale.set(i,i,i),r.userData=e,s.push(r),o.add(r)}),t.add(o);let c=new Yi,l=new K;window.addEventListener(`click`,e=>{if(i.style.display===`flex`){i.style.display=`none`,i.innerHTML=``;return}l.x=e.clientX/window.innerWidth*2-1,l.y=-(e.clientY/window.innerHeight)*2+1,c.setFromCamera(l,n);let t=c.intersectObjects(s);if(t.length>0){let e=t[0].object.userData;u(e)}});function u(e){i.style.display=`flex`;let t=`<h1>${e.title}</h1>`;e.type===`text`?t+=`<p style="white-space: pre-wrap; max-width: 600px;">${e.text}</p>`:e.type===`link`&&(t+=`<p>${e.description}</p>
                        <a href="${e.url}" target="_blank" style="color: #00ffcc;">点击跳转访问</a>`),t+=`<p style="margin-top: 40px; font-size: 0.8em; color: #888;">(点击任意处关闭)</p>`,i.innerHTML=t}let d=new Qi;function f(){requestAnimationFrame(f);let e=d.getElapsedTime();o.rotation.y=e*.1,o.rotation.x=e*.05,s.forEach((t,n)=>{t.position.y+=Math.sin(e+n)*.002,t.material.uniforms.uTime.value=e}),r.render(t,n)}window.addEventListener(`resize`,()=>{n.aspect=window.innerWidth/window.innerHeight,n.updateProjectionMatrix(),r.setSize(window.innerWidth,window.innerHeight)}),f()}_c();